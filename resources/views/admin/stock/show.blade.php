...
<div class="card">
    ...
    <div class="detail-container">
        <div class="detail-image">
            @if($stock->buku->foto)
                <img src="{{ asset('storage/' . $stock->buku->foto) }}" alt="Foto Buku" style="width: 200px; height: 280px; object-fit: cover;">
            @else
        ...
        <div class="detail-info">
            <table>
                ...
                <tr>
                    ...
                    <td>{{ $stock->buku->subKategoris->kategoris->nama_kategori ?? '-' }}</td>
                </tr>
                <tr>
                    <td><strong>Jumlah Stock:</strong></td>
                    <td>{{ $stock->stock }}</td>
                </tr>
                <tr>
